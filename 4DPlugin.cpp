...
PA_long32 get_picture_index(PA_Picture p, const char *type)
{
	PA_long32 i = 0;
...
// --- TIFF
		...
		case 1 :
			TIFF_Count_pages(pResult, pParams);
			break;

		case 2 :
			TIFF_GET_PAGES(pResult, pParams);
			break;

		case 3 :
			TIFF_Create_from_array(pResult, pParams);
			break;

// --- GIF

		case 4 :
			GIF_Count_pages(pResult, pParams);
			break;

		case 5 :
			GIF_GET_PAGES(pResult, pParams);
			break;

		case 6 :
			GIF_Create_from_array(pResult, pParams);
			break;
...
// --- PDF
		...
		case 8 :
			PDF_GET_PAGES(pResult, pParams);
			break;

		case 9 :
			PDF_Create_from_array(pResult, pParams);
			break;
	...
	if(i)
	{
		...
		if(PA_GetLastError() == eER_NoErr)
		{
			...
			if(tiff_input.len)
			{
				...
				if(tiff)
				{
					returnValue.setIntValue(get_page_count(tiff));
					TIFFClose(tiff);
				}//tiff
		...
		if(PA_GetLastError() == eER_NoErr)
		{
			...
			if(tiff_input.len)
			{
				...
				if(tiff)
				{
					...
					int param_start = Param3.getIntValue();
					int param_end = Param4.getIntValue();
...
void GIF_Count_pages(sLONG_PTR *pResult, PackagePtr pParams)
{
	...
	// --- write the code of GIF_Count_pages here...
...
void GIF_GET_PAGES(sLONG_PTR *pResult, PackagePtr pParams)
{
	...
	// --- write the code of GIF_GET_PAGES here...
...
//    Param1.fromParamAtIndex(pParams, 1);
	...
	// --- write the code of GIF_Create_from_array here...
...
void PDF_Count_pages(sLONG_PTR *pResult, PackagePtr pParams)
{
	...
	// --- write the code of PDF_Count_pages here...
...
void PDF_GET_PAGES(sLONG_PTR *pResult, PackagePtr pParams)
{
	...
	// --- write the code of PDF_GET_PAGES here...
...
//    Param1.fromParamAtIndex(pParams, 1);
	...
	// --- write the code of PDF_Create_from_array here...
